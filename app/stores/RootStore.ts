...
import CollectionMembershipsStore from "./CollectionMembershipsStore";
...
export default class RootStore {
  ...
  collectionMemberships: CollectionMembershipsStore;
  ...
  constructor() {
    ...
    this.collectionMemberships = new CollectionMembershipsStore(this);
  ...
  logout() {
    ...
    this.documentMemberships.clear();
    this.documentGroupMemberships.clear();
    this.events.clear();
    this.groups.clear();
