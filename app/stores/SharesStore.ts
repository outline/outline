...
export default class SharesStore extends BaseStore<Share> {
  ...
  @action
  async fetch(documentId: string, options: any = {}): Promise<any> {
  ...
  getByDocumentParents = (documentId: string): Share | undefined | null => {
  ...
  getByDocumentId = (documentId: string): Share | undefined | null => {
