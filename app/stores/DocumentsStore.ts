...
export default class DocumentsStore extends BaseStore<Document> {
  ...
  @observable
  movingDocumentId: string | undefined | null;
  ...
  @computed
  get active(): Document | undefined | null {
  ...
  @action
  fetchArchived = async (options?: PaginationParams | null): Promise<any> => {
    return this.fetchNamedPage("archived", options);
  };

  @action
  fetchDeleted = async (options?: PaginationParams | null): Promise<any> => {
  ...
  @action
  fetchTemplates = async (options?: PaginationParams | null): Promise<any> => {
  ...
  @action
  fetchStarred = (options?: PaginationParams | null): Promise<any> => {
    return this.fetchNamedPage("starred", options);
  };

  @action
  fetchDrafts = (options?: PaginationParams | null): Promise<any> => {
    return this.fetchNamedPage("drafts", options);
  };

  @action
  fetchPinned = (options?: PaginationParams | null): Promise<any> => {
    return this.fetchNamedPage("pinned", options);
  };

  @action
  fetchOwned = (options?: PaginationParams | null): Promise<any> => {
    return this.fetchNamedPage("list", options);
  };
  ...
  @action
  templatize = async (id: string): Promise<Document | undefined | null> => {
    const doc: Document | undefined | null = this.data.get(id);
  ...
  fetch = async (
    ...
    try {
      const doc: Document | undefined | null =
  ...
  getByUrl = (url: string = ""): Document | undefined | null => {
