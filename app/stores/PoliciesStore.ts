...
export default class PoliciesStore extends Store<Policy> {
   ...
   * when a user loses a membership due to being removed from eg a group, notebook or
   * note. Once all membership IDs are removed, the ability is no longer valid and
   ...
   * is related to, eg a notebook, document or group.
   *
