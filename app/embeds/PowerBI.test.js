...
describe("PowerBI", () => {
  ...
  test("to be enabled on dashboard", () => {
    expect(
      "https://app.powerbi.com/view?r=eyJrIjoiMjcxNDIyNjAtOGM0Yi00ZWJhLWJkNmEtNjFiOTI0MWVlYjNiIiwidCI6IjI1NmNiNTA1LTAzOWYtNGZiMi04NWE2LWEzZTgzMzI4NTU3OCIsImMiOjh9"
      .match(match)
    ).toBeTruthy();
  });
