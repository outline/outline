  ...
  const config = useComputed(() => {
    const items: ConfigItem[] = [
      ...
      },
      {
        ...
        prefetch: Notifications.prefetch,
        enabled: true,
        group: t("Account"),
        icon: EmailIcon,
      },
      {
        ...
        prefetch: APIAndAccess.prefetch,
        enabled: true,
        group: t("Account"),
        icon: PadlockIcon,
      },
      ...
      },
      {
        ...
        prefetch: Authentication.prefetch,
        enabled: can.update,
        group: t("Workspace"),
        icon: PadlockIcon,
      },
      ...
      },
      {
        ...
        prefetch: CustomEmojis.prefetch,
        enabled: can.update,
        group: t("Workspace"),
        icon: SmileyIcon,
      },
      ...
      },
      {
        ...
        prefetch: Applications.prefetch,
      ...
      },
      {
        ...
        prefetch: Integrations.prefetch,
        enabled: can.update,
        group: t("Integrations"),
        icon: PlusIcon,
      },
    ...
    PluginManager.getHooks(Hook.Settings).forEach((plugin) => {
      ...
      items.splice(insertIndex, 0, {
        ...
        prefetch: plugin.value.component.prefetch,
