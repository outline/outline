...
export default class Document extends BaseModel {
  ...
  @observable
  embedsDisabled: boolean = false;
  @observable
  injectTemplate: boolean = false;
  @observable
  lastViewedAt: string | undefined | null;
  ...
  parentDocumentId: string | undefined | null;
  ...
  constructor(fields: any, store: DocumentsStore) {
    super(fields, store);
  ...
  @computed
  get permanentlyDeletedAt(): string | undefined | null {
    if (!this.deletedAt) {
      return undefined;
    }
  ...
  @computed
  get placeholder(): string | undefined | null {
  ...
  move = (collectionId: string, parentDocumentId?: string | null) => {
