...
/**
 * Tailwind UI – page headings: with meta  actions  and breadcrumbs.
 *
 * @returns the rendered component.
 */
export function PageHeadingsWithMetaActionsAndBreadcrumbs() {
  return (
    <div className="lg:flex lg:items-center lg:justify-between">
      ...
      <div className="mt-5 flex lg:ml-4 lg:mt-0">
        ...
        <Menu as="div" className="relative ml-3 sm:hidden">
          <Menu.Button className="inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-xs ring-1 ring-inset ring-gray-300 hover:ring-gray-400">
            More
            <ChevronDownIcon
          ...
          >
            <Menu.Items className="absolute right-0 z-10 -mr-1 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black/5 focus:outline-hidden">
              <Menu.Item>
                {({ active }) => (
                  <a
                    href="#"
