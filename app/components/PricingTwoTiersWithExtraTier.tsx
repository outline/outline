...
/**
 * Tailwind UI – pricing: two tiers with extra tier.
 *
 * @returns the rendered component.
 */
export function PricingTwoTiersWithExtraTier() {
  return (
              ...
              {tiers.map((tier) => (
                ...
                >
                  ...
                  <a
                    ...
                    className="mt-8 block rounded-md bg-indigo-600 px-3.5 py-2 text-center text-sm font-semibold leading-6 text-white shadow-xs hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                  >
                    Get started today
                  </a>
                </div>
