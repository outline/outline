...
/**
 * Tailwind UI – order history pages: simple.
 *
 * @returns the rendered component.
 */
export function OrderHistoryPagesSimple() {
        ...
        <div className="mt-16 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 sm:gap-y-16 lg:grid-cols-3 lg:gap-x-8 xl:grid-cols-4">
          {orders.map((order) => (
            <div key={order.id} className="group relative">
              <div className="aspect-[1/1] overflow-hidden rounded-md bg-gray-200 group-hover:opacity-75">
                <img
                  src={order.imageSrc}
                  alt={order.imageAlt}
