...
/**
 * Tailwind UI – product pages: with expandable product details.
 *
 * @returns the rendered component.
 */
export function ProductPagesWithExpandableProductDetails() {
        ...
        <div className="mx-auto max-w-2xl lg:max-w-none">
          ...
          <div className="lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-8">
            ...
            <Tab.Group as="div" className="flex flex-col-reverse">
              ...
              <div className="mx-auto mt-6 hidden w-full max-w-2xl sm:block lg:max-w-none">
                <Tab.List className="grid grid-cols-4 gap-6">
                  {product.images.map((image) => (
                    <Tab
                      key={image.id}
                      className="relative flex h-24 cursor-pointer items-center justify-center rounded-md bg-white text-sm font-medium uppercase text-gray-900 hover:bg-gray-50 focus:outline-hidden focus:ring-3 focus:ring-offset-4"
                    >
                      {({ selected }) => (
                        <>
              ...
              <Tab.Panels className="aspect-[1/1] w-full">
                {product.images.map((image) => (
