...
function ConnectedCollection({ integration, collection }: Props) {
          ...
          <Popover {...popover} aria-label={t("Settings")}>
            <Events>
              ...
              <Text as="p" type="secondary">
                <Trans
                  defaults="These events should be posted to {{ integrationName }}"
...
export default observer(ConnectedCollection);
