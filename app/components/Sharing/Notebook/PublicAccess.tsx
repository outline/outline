...
function InnerPublicAccess(
  ...
  const notebookAbilities = usePolicy(notebook);
  const canPublish = share ? can.update : notebookAbilities.share;
          ...
          <>
            ...
            <Flex align="flex-start" gap={4}>
              ...
              <Text type="tertiary" size="xsmall">
                {t(
                  "All documents in this notebook will be shared on the web, including any new documents added later"
                )}
                .
              </Text>
            </Flex>
