...
/**
 * Tailwind UI – command palettes: dark with icons.
 *
 * @returns the rendered component.
 */
export function CommandPalettesDarkWithIcons() {
    ...
    >
      <Dialog as="div" className="relative z-10" onClose={setOpen}>
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto p-4 sm:p-6 md:p-20">
          ...
          >
            <Dialog.Panel className="mx-auto max-w-2xl transform divide-y divide-gray-500/20 overflow-hidden rounded-xl bg-gray-900 shadow-2xl transition-all">
              <Combobox
