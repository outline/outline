...
type Props = {
  ...
  /** Icon color */
  color: string;
  /** Placeholder to display when the note has no title */
  placeholder?: string;
...
const NoteTitle = React.forwardRef(function NoteTitle_(
  {
    noteId,
    title,
    icon,
...
`;
export default observer(NoteTitle);
