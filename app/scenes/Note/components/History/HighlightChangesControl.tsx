...
export function HighlightChangesControl({
  ...
  const compareOptions = React.useMemo((): Option[] => {
    ...
    const resolvedSelectedId =
      selectedRevisionId === "latest" && note
        ? RevisionHelper.latestId(note.id)
        : selectedRevisionId;
    ...
    const latestId = note ? RevisionHelper.latestId(note.id) : undefined;
    ...
    return options;
  }, [items, selectedRevisionId, note, userLocale, t]);
  return (
    <Content>
