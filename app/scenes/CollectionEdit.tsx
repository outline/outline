...
class CollectionEdit extends React.Component<Props> {
  @observable
  name: string = this.props.collection.name;
  @observable
  sharing: boolean = this.props.collection.sharing;
  @observable
  icon: string = this.props.collection.icon;
  @observable
  color: string = this.props.collection.color || "#4E5C6E";
  @observable
  sort: {
    field: string;
    direction: "asc" | "desc";
  ...
  handleSubmit = async (ev: SyntheticEvent<any>) => {
    ev.preventDefault();
    this.isSaving = true;
    const { t } = this.props;
  ...
  handleSortChange = (ev: ChangeEvent<HTMLSelectElement>) => {
  ...
  handleNameChange = (ev: ChangeEvent<any>) => {
  ...
  handleSharingChange = (ev: ChangeEvent<any>) => {
