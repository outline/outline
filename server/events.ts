...
export type UserEvent = {
  ...
  "users.create" | "users.signin" | "users.update" | "users.suspend" | "users.activate" | "users.delete",
  userId: string,
  teamId: string,
  actorId: string,
  ip: string
...
export type DocumentEvent = {
  name: // eslint-disable-line
  "documents.create" | "documents.publish" | "documents.delete" | "documents.pin" | "documents.unpin" | "documents.archive" | "documents.unarchive" | "documents.restore" | "documents.star" | "documents.unstar",
  documentId: string,
  collectionId: string,
  teamId: string,
  actorId: string,
  ...
  name: // eslint-disable-line
  "documents.update" | "documents.update.delayed" | "documents.update.debounced",
  documentId: string,
  collectionId: string,
  createdAt: string,
  teamId: string,
...
export type Event = UserEvent | DocumentEvent | CollectionEvent | IntegrationEvent | GroupEvent | RevisionEvent | TeamEvent;
