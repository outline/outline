...
export default function collectionIndexing() {
  return async function collectionIndexingMiddleware(
    ctx: Context,
    next: () => Promise<*>
  ) {
    ...
    // make the index null, if there is index collision or exisitng collection with same index.
