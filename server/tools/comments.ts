...
/**
 * Registers comment-related MCP tools on the given server.
 *
 * @param server - the MCP server instance to register tools on.
 */
export function commentTools(server: McpServer) {
  server.registerTool(
    "list_comments",
    {
      title: "List comments",
  ...
  server.registerTool(
    "create_comment",
    {
      ...
      inputSchema: {
        ...
        text: z.string().describe("The markdown text content of the comment."),
        parentCommentId: z
          .string()
          .optional()
          .describe(
