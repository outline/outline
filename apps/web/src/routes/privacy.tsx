...
export const Route = createFileRoute("/privacy")({
	head: () => ({
		meta: [
			{ title: i18n.t("privacy_page.meta_title") },
			{
				name: "description",
				content: i18n.t("privacy_page.meta_description"),
			},
			{
				name: "keywords",
				content: i18n.t("privacy_page.meta_keywords"),
			},
			// Open Graph
			{ property: "og:title", content: i18n.t("privacy_page.og_title") },
			{
				property: "og:description",
				content: i18n.t("privacy_page.og_description"),
			},
	...
	return (
		<main className="w-full bg-paper-white min-h-screen text-true-black font-inter py-20 px-6">
			<div className="max-w-[800px] mx-auto bg-white border border-mist-gray rounded-lg p-8 md:p-12 ">
				...
				>
					&larr; {t("privacy_page.back_to_home")}
				</Link>
