...
export const LANGUAGES = {
  ...
  zig: "Zig",
  // kroki diagrams;
  kroki_blockdiag: "BlockDiag",
  kroki_bpmn: "BPMN",
  kroki_bytefield: "Bytefield",
  kroki_seqdiag: "SeqDiag",
  kroki_actdiag: "ActDiag",
  kroki_nwdiag: "NwDiag",
  kroki_packetdiag: "PacketDiag",
  kroki_rackdiag: "RackDiag",
  kroki_c4plantuml: "C4 with PlantUML",
  kroki_d2: "D2",
  kroki_dbml: "DBML",
  kroki_ditaa: "Ditaa",
  kroki_erd: "Erd",
  kroki_excalidraw: "Excalidraw",
  kroki_graphviz: "GraphViz",
  kroki_mermaid: "Mermaid",
  kroki_nomnoml: "Nomnoml",
  kroki_pikchr: "Pikchr",
  kroki_plantuml: "PlantUML",
  kroki_structurizr: "Structurizr",
  kroki_svgbob: "Svgbob",
  kroki_symbolator: "Symbolator",
  kroki_tikz: "TikZ",
  kroki_vega: "Vega",
  kroki_vegalite: "Vega-Lite",
  kroki_wavedrom: "WaveDrom",
  kroki_wireviz: "WireViz",
};
