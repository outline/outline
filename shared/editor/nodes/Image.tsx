...
export default class Image extends Node {
  ...
  handleMouseDown = (ev: React.MouseEvent<HTMLSpanElement>) => {
  ...
  component = (props: ComponentProps) => {
    return (
      <ImageComponent
        ...
        onCaptionKeyDown={this.handleKeyDown(props)}
        onCaptionBlur={this.handleBlur(props)}
        onCaptionMouseDown={this.handleMouseDown}
