...
/**
 * The value a filter condition compares against. Dates cross the wire as ISO
 * 8601 strings, so there is no Date member here – one would fail every field
 * kind anyway, and it cannot be represented in JSON Schema.
 */
