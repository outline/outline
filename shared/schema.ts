...
const BaseImportInputItemSchema = z.object({
  permission: z.enum(NotebookPermission).optional(),
});
...
export const BaseImportTaskInputItemSchema = z.object({
  ...
  notebookExternalId: z.string().optional(),
});
 ...
 * references in note/notebook content into new redirect URLs that point
